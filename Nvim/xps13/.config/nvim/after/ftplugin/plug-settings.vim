...
" https://betterprogramming.pub/how-to-show-an-ascii-art-welcome-screen-at-the-top-of-the-vim-terminal-b8787f6ea9f4
...
"Suckless
command! -bang SucklessFiles call fzf#vim#files('/home/carl/.config/Suckless/suckless-carl', <bang>0)
"Previewer
command! -bang -nargs=? -complete=dir SucklessFiles
    \ call fzf#vim#files(<q-args>, fzf#vim#with_preview({'options': ['--layout=reverse', '--info=inline']}), <bang>0)

"Dotfiles
command! -bang DotFiles call fzf#vim#files('~/.Dot', <bang>0)
"Previewer
